                            ...
                            chapters.map((chapter, index) => (
                                ...
                                >
                                    ...
                                    <textarea
                                        ...
                                        rows={2}
                                        className="w-full pl-9 text-sm text-gray-600 bg-transparent border-none focus:outline-none focus:ring-0 resize-none placerholder-gray-400"
                                    />
                                </div>
                            ))
                        )}
